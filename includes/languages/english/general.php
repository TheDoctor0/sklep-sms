...
return [
    ...
    'bought_service_info'               => 'Service was purchased {1}. Data: {2} Qunatity: {3} Server: {4} Transaction ID: {5}. Email: {6} {7}({8})({9})',
    'cancel'                            => 'Cancel',
    ...
    'mysqli_no_query_fetch_array_assoc' => 'Could not fetch array assoc because no query id was supplied!',
    ...
    'not_logged_or_no_perm'             => 'Something is wrong, you are not logged in or you have no permission oO',
    'november'                          => 'November',
    'october'                           => 'October',
    ...
    'payment_remove_code_from_db'       => 'Code was removed from the list of codes to be used. Code: {1} Tariff: {2}',
    'question'                          => 'Question',
    'regards'                           => 'Regards',
