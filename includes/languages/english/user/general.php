...
return [
    ...
    'bad_sms_code_used'               => 'SMS transaction of user: {1}({2})({3}) failed. Used return code: {4} Content: {5} Number: {6} Error code: {7}',
    ...
    'different_email'                 => 'Given e-mails are different.',
    'different_pass'                  => 'Given passwords are different.',
    ...
    'no_login_password'               => 'Unfortunately, without providing nickname and login, you can\'t log in.',
    'no_reset_key'                    => 'No reset key was given.',
    'no_sms_payment'                  => 'You can\'t pay by SMS for service quantity. Choose another payment method.',
    ...
    'password_change'                 => 'In order to change password to your account, enter old password. Then enter new password and type it again.',
    'password_changed'                => 'Password was changed successfully.',
    'password_repeat'                 => 'Repeat password',
    'password_reset'                  => 'In order to change password to your account, enter new password and type it again.',
    'pay_sms'                         => 'Pay by SMS',
    ...
    'register_success'                => 'Account registered successfully. In a moment you will be automatically logged in.',
    'register_vert'                   => 'R<br />E<br />G<br />I<br />S<br />T<br />E<br />R',
    'regulations'                     => 'Regulations',
    'repeat'                          => 'Repeat',
    'required_data'                   => 'Required data',
    'reset_key_email'                 => 'E-mail with password reset key has been sent. User: {1}({2}) E-mail: {3} Form data. User name: {4} E-mail: {5}',
...
At the next step, an e-mail with a link to restore password will be send to you.',
    ...
    'service_not_displayed'           => 'Service cannot be displayed, because its module does not provide such functionality.',
    'service_takeover'                => '<strong>Service takeover</strong> is to assign specific, time-bound service to your account. Usually used when buying service while not logged in.',
...
You can now profit from many add-ons.',
    ...
    'sms_info_bad_number'             => 'Code is OK, but unfortunately obtained by sending SMS on different number.',
    'sms_info_external_error'         => 'Unknown error occurred on the API side.',
    'sms_info_insufficient_data'      => 'Not all the necessary data were given in payment configuration.',
    'sms_info_no_connection'          => 'No connection to the verification script.',
    'sms_info_ok'                     => 'Given return code is correct.',
    'sms_info_server_error'           => 'Something bad happened on the API side. Report the error to the shop owner.',
    'sms_info_sms_not_supported'      => 'This service does not operate SMS payment. Report the error to the shop owner.',
    'sms_info_unknown_error'          => 'An unknown error occured. Report it to the shop owner.',
    'sms_info_wrong_credentials'      => 'Incorrectly configured payment method. Report it to the shop owner.',
    'sms_number'                      => 'Number',
    ...
    'transfer_bad_module'             => 'Transfer payment: {1} was accepted, but service module {2} wasn\'t found and purchase failed.',
    'transfer_cost'                   => 'Transfer cost',
    'transfer_error'                  => 'Unfortunately, transfer payment failed.',
    'transfer_finalized'              => 'Transaction finalized',
    'transfer_no_data_file'           => 'Transfer payment: {1} was accepted, but there was no file with purchase data.',
    'transfer_no_purchase'            => 'Transfer payment: {1} was accepted, but service module {2} doesn\'t implement IService_Purchase interface.',
    'transfer_prepared'               => 'Payment preparation successful.<br />In a minute you will be send to transaction service.',
    'transfer_transfer'               => 'Transfer',
    'transfer_transfer_not_supported' => 'This service does not operate transfer payment. Report the error to the shop owner.',
...
Contact our service administrator to receive more information.',
    'wrong_sender_email'              => 'E-mail assigned you your account is incorrect. Report it to the shop owner.',
